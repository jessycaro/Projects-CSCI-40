...
int main()
{
	...
	// and pesos
	    cout << "Converted: " << dollars << " dollars = " << euros << " euros and " << pesos << " pesos" << endl;
	...
	// pesos and yen
	    cout << "Converted: " << dollars << " dollars = " << euros << " euros, " << pesos << " pesos, and " << yen << " yen" << endl;
	...
	cout << "Converted: " << dollars << " dollars = " << yen << " yen" << endl;
	...
	// Fill in the code to output the value of those dollars converted to euros
	cout << "Converted: " << dollars << " dollars = " << euros << " euros" << endl;
	...
	// Fill in the code to output the value of those dollars converted to pesos
	 cout << "Converted: " << dollars << " dollars = " << pesos << " pesos" << endl;
